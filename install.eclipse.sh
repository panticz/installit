...
if [ "$(uname -m)" == "x86_64" ]; then
  # 64 bit
  URL=http://mirror.netcologne.de/eclipse/technology/epp/downloads/release/kepler/SR2/eclipse-jee-kepler-SR2-linux-gtk-x86_64.tar.gz
else
  # 32 bit
  URL=http://mirror.netcologne.de/eclipse/technology/epp/downloads/release/kepler/SR2/eclipse-jee-kepler-SR2-linux-gtk.tar.gz
fi
